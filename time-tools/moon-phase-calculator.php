<?php
$page_title = 'Moon Phase Calculator – Free Online | Time Tools';
$page_description = '';
$breadcrumbs = [
    ['title' => 'Home', 'url' => 'index.php'],
    ['title' => 'Moon Phase Calculator', 'url' => '']
];
$page_css = 'moon-phase-calculator.css';
$page_js = 'moon-phase-calculator.js';
include 'header.php';
?>
  ...
  <div class="row justify-content-center">
    <div class="col-lg-6">
      <div class="card p-4 text-center">
        ...
        <input id="date" type="date" class="form-control mb-4" onchange="calc()">
        <div id="result"></div>
      </div>
    </div>
  </div>
