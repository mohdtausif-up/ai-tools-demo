<?php
$page_title = 'Sunrise & Sunset Calculator – Free Online | Time Tools';
$page_description = '';
$breadcrumbs = [
    ['title' => 'Home', 'url' => 'index.php'],
    ['title' => 'Sunrise Sunset Calculator', 'url' => '']
];
$page_css = 'sunrise-sunset-calculator.css';
$page_js = 'sunrise-sunset-calculator.js';
include 'header.php';
?>
