<?php
$page_title = 'Weekly Planner – Free Online | Time Tools';
$page_description = 'Plan your week with time blocks.';
$breadcrumbs = [
    ['title' => 'Home', 'url' => 'index.php'],
    ['title' => 'Weekly Planner', 'url' => '']
];
$page_css = 'weekly-planner.css';
$page_js = 'weekly-planner.js';
include 'header.php';
?>
